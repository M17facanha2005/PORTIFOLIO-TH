  ...
  return (
    <SHome>
      <SHeader>
        <div>
          <p>
            Olá! <a>Me chamo</a> <span>Matheus Façanha Torres</span>
          </p>
          <h1>
            front-end
            <br />
          ...
          <footer>
            ...
            <small style={{ overflowY: "hidden" }}>
              <Typewriter
                words={[
                  "Desenvolvedor Front-End com habilidades em html, css e Javascript  em bots de discord. Familiarizado com metodologias ágeis e organização de projetos.",
                ]}
                typeSpeed={15}
                cursor
                cursorStyle="|"
      ...
      <SAboutMe>
        ...
        <div className="content">
          <h1>SOBRE MIM</h1>
          <h2>
            Olá, meu nome é Matheus Façanha Torres, tenho 20 anos, sou
